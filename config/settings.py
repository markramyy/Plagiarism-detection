...
SECRET_KEY = 'django-insecure-i2s^lim5spu*)yc^2vsxnj-m*g5qtmn52wy500h2$l1$idcq)q'
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Documentation of API endpoints of Plagiarism Detection",
    "VERSION": "1.0.0",
...
with open(os.path.join(BASE_DIR, "config", "private_key.pem"), 'r') as f:
    private_key = f.read()


with open(os.path.join(BASE_DIR, "config", "public_key.pem"), 'r') as f:
    public_key = f.read()
...
SIMPLE_JWT = {
    ...
    "AUDIENCE": None,
    "ISSUER": "Plagiarism Detection API",
    "JSON_ENCODER": None,
    "JWK_URL": None,
    "LEEWAY": 0,
